...
const translations = {
  en: {
    ...
    'options.title': 'Configure Your Assessment',
    'options.desc': 'Would you like to see your "weaknesses" in the final results? (Some people prefer not to focus on them, you can turn this off if you prefer.)',
    'options.show_weakness': 'Yes, show my weaknesses',
    'options.hide_weakness': 'No, focus only on my strengths',
    'options.start': 'Start Assessment',
    ...
    'r.weaknesses': 'Potential Blind Spots',
    'r.tradeoffs': 'Cognitive Trade-offs',
    'r.dependencies': 'Activated Dependencies',
    'r.summary': 'Summary',
    'cat.Energy': 'Energy',
  ...
  ja: {
    ...
    'options.title': '診断の設定',
    'options.desc': '診断結果であなたの「弱み」も表示しますか？（自分の弱みを見たくない場合はオフにできます）',
    'options.show_weakness': 'はい、弱みも見ます',
    'options.hide_weakness': 'いいえ、強みだけを見ます',
    'options.start': '診断を開始する',
    'q.sector': 'マッピングノード領域',
    'q.prev': '戻る',
    'q.next': '次の領域へ',
    'q.complete': 'スキャン完了',
    ...
    'r.weaknesses': '潜在的な成長課題（ボトム3）',
    'r.tradeoffs': '認知のトレードオフ',
    'r.dependencies': '特性のシナジーと依存関係',
  ...
  ko: {
    ...
    'options.title': '진단 설정',
    'options.desc': '진단 결과에서 \'약점\'도 함께 볼까요? (약점을 보고 싶지 않다면 끌 수 있습니다)',
    'options.show_weakness': '네, 약점도 보겠습니다',
    'options.hide_weakness': '아니요, 강점만 보겠습니다',
    'options.start': '진단 시작하기',
    'q.sector': '매핑 노드 섹터',
    'q.prev': '이전',
    'q.next': '다음 섹터로',
    'q.complete': '분석 완료',
    ...
    'r.weaknesses': '잠재적 보완점 (하위 3개)',
    'r.tradeoffs': '인지적 트레이드오프',
    'r.dependencies': '특성 시너지 및 의존성',
    'r.summary': '핵심 요약',
    'cat.Energy': '에너지',
  ...
  zh: {
    ...
    'options.title': '评估设置',
    'options.desc': '您希望在结果中看到您的“弱点”吗？（如果您不想关注弱点，可以选择不显示）',
    'options.show_weakness': '是的，显示弱点',
    'options.hide_weakness': '不，只关注优势',
    'options.start': '开始评估',
    'q.sector': '映射节点区域',
    'q.prev': '上一个',
    'q.next': '下一个区域',
    ...
    'r.weaknesses': '潜在盲点与成长空间',
    'r.tradeoffs': '认知权衡',
    'r.dependencies': '激活的依赖特征',
    'r.summary': '概要',
    'cat.Energy': '能量',
  ...
  th: {
    ...
    'options.title': 'ตั้งค่าการประเมิน',
    'options.desc': 'คุณต้องการดู "จุดอ่อน" ของคุณในผลลัพธ์หรือไม่? (บางคนอาจไม่อยากดูจุดอ่อนของตัวเอง สามารถปิดได้)',
    'options.show_weakness': 'ใช่ ฉันต้องการดูจุดอ่อน',
    'options.hide_weakness': 'ไม่ ฉันอยากดูแค่จุดแข็ง',
    'options.start': 'เริ่มการประเมิน',
    ...
    'r.weaknesses': 'จุดบอดศักยภาพและพื้นที่สำหรับการพัฒนา',
    'r.tradeoffs': 'การแลกเปลี่ยนทางปัญญา (Trade-offs)',
    'r.dependencies': 'การพึ่งพาและเสริมแรงร่วม (Dependencies)',
    'r.summary': 'บทสรุป',
