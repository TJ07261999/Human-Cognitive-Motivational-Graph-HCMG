...
const translations = {
  en: {
    ...
    'r.subtitle': 'Your cognitive-motivational graph has been mapped to our global database anonymously.',
  ...
  ja: {
    ...
    'r.home': 'ホーム',
    'r.title': 'トポロジー生成完了',
    'r.subtitle': 'あなたの認知・動機グラフがグローバルデータベースに匿名でマッピングされました。',
  ...
  ko: {
    ...
    'r.home': '홈',
    'r.title': '토폴로지 생성 완료',
    'r.subtitle': '귀하의 인지-동기 그래프가 글로벌 데이터베이스에 익명으로 매핑되었습니다.',
